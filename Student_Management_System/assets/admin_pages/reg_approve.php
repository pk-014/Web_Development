...
<script>
    ...
    document.getElementById('Registrations').classList.add('active');
        ...
        <form method="POST" action="approval.php" class="user" style="width:60%">
                                ...
                                <div class="form-group hidden">
                                    <input type="hidden" class="form-control form-control-user" id="exampleInputEmail" name="oldID"
                                ...
                                <div class="form-group hidden">
                                    ...
                                    <select required id="role" class="form-control form-control-user" name="userRole">
