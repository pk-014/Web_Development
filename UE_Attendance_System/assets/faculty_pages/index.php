...
$id = $_SESSION["user_id"];
$students = mysqli_fetch_all(mysqli_query($c, "select course_code from courses where assigned_to = '$id'"));
$total_students = 0;
foreach($students as $st){
    $st = $st[0]."_students";
    $total_students+= mysqli_fetch_array(mysqli_query($c, "SELECT COUNT(*) FROM $st;"))[0];
}
$courses = mysqli_fetch_array(mysqli_query($c, "SELECT COUNT(*) FROM courses where assigned_to='$id';"))[0];
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Absents Today
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
