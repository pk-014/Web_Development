...
<script>
    ...
    document.getElementById('Courses').classList.add('active');
        ...
        <form method="POST" action="add_course_submit.php" class="user" style="width:60%">
            <br>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        placeholder="Enter unique course name here" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    placeholder="bsf1234567">
                                </div>
                                
                                <br>
                                <input type="submit"class="btn btn-primary btn-user btn-block" value="Add Course">
